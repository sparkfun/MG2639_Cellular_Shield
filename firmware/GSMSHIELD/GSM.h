...
#define POWER_CONTROL()   {digitalWrite(GSM_ON, LOW); delay(3000); digitalWrite(GSM_ON, HIGH); }
...
//Module specific timings
//Pulse timings to power on/off module

//Works with SIM9000
//#define POWER_CONTROL()     {digitalWrite(GSM_ON, HIGH); delay(1200); digitalWrite(GSM_ON, LOW); delay(10000); }
...
public:
     ...
     byte comm_buf[MAX_COMM_BUF_LEN+1];  // communication buffer +1 for 0x00 termination
