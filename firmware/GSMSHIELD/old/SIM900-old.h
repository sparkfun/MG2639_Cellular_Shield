...
//Module specific AT commands for SIM9000
#define SET_GPRS_SERVICE    "AT+CGATT"
#define LOCAL_IP_ADDRESS    "AT+CIFSR"
#define CLOSE_CONNECTION    "AT+CIPCLOSE"
...
#define START_TCP_CONNECTION    "AT+CIPSTART"
#define SEND_TCP_DATA       "AT+CIPSEND"
